    ...
    public class Seletor
    {
        ...
        private Dictionary<TipoEquipamento, int> inputSolicitacao()
        {
            ...
            while (sair != '0')
            {
                ...
                {
                    Console.WriteLine("\n\nA quantidade deve ser positiva, ou seja, maior que zero.\n");
                    continue;
                }

                solicitacoes.Add(tipoEquipamento, qtdTipoEquipamento);

                Console.Write("Deseja adicionar mais algum tipo de quipamento?. Se não, digite o número 0 e se sim pressione qualquer tecla! ");
